# -*- coding: utf-8 -*-
"""Text diversity (online metric): TTR, Distinct-2/3, 1-Self-BLEU, Div_sem for Weibo reposts."""
...
def compute_diversity_metrics(
    ...
    *,
    ...
    cleaned = [t.strip() for t in texts if (t or "").strip()]
    if not cleaned:
        raise ValueError("no valid repost texts")
